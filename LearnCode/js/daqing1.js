...
center: ol.proj.fromLonLat([124.65087890625,45.7598586878557]),
zoom:8
 }); //map.view的变量
///
///设置地图显示范围
...
///
    ...
    ///
      ...
      var KaiCaiKQKMLLayer = new ol.layer.Vector({
      ...
      map.addLayer(KaiCaiKQKMLLayer);

    ///
    ///加入到图层数组
    ///
       mapLayers[2] = KaiCaiKQKMLLayer;
